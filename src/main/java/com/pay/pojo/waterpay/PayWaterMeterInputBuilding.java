 ...
 */
@Entity
@IdClass(PayWaterMeterInputBuildingPK.class)
...
public class PayWaterMeterInputBuilding implements Serializable {
	...
	private List<PayWaterMeterInputDetail> waterMeterInputDetails;
	...
	@Transient
	public List<PayWaterMeterInputDetail> getWaterMeterInputDetails() {
		return waterMeterInputDetails;
	}

	public void setWaterMeterInputDetails(
			List<PayWaterMeterInputDetail> waterMeterInputDetails) {
		this.waterMeterInputDetails = waterMeterInputDetails;
	}
