...
public class DESUtils {
	...
	// KEY种子
	private static String KEY_STR = "waterpay";
	// 常量
	...
	public static void main(String[] args) {
		...
		System.out.println("email.equals(decrypted): "
				+ email.equals(decrypted));
		
		//System.out.println("test: " + DESUtils.decode("fang13859"));
	}
}