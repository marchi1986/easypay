 ...
 */
public class PaymentReceiptForPrint2 implements Printable {
		...
		for(int i = 1; i < 15; i++){
			...
			switch(i){
				...
				case 5:
					...
					g2.setFont(gridFont); // 设置字体
					g2.drawLine(leftPointX + lineSpace, (int) line, leftPointX + lineSpace, (int) (line + rowHight)); //中竖线
					g2.drawLine(leftPointX +25+ lineSpace*2, (int) line, leftPointX +25+ lineSpace*2, (int) (line + rowHight)); //中竖线
					g2.drawLine(leftPointX +45+ lineSpace*3, (int) line, leftPointX +45+ lineSpace*3, (int) (line + rowHight)); //中竖线
					g2.drawLine(leftPointX +70+ lineSpace*4, (int) line, leftPointX +70+ lineSpace*4, (int) (line + rowHight)); //中竖线
					g2.drawLine(leftPointX +70+ lineSpace*5, (int) line, leftPointX +70+ lineSpace*5, (int) (line + rowHight)); //中竖线
					g2.drawLine(leftPointX +70+ lineSpace*6, (int) line, leftPointX +70+ lineSpace*6, (int) (line + rowHight)); //中竖线
				...
				case 6:
					...
					g2.drawString(String.valueOf(this.getOtherPrice()), (float)leftPointX + 430, (float) line + gridTitleFontHeight);
					g2.drawString(String.valueOf(this.amonut2), (float)leftPointX + 500, (float) line + gridTitleFontHeight);
				...
				case 7:
					...
					g2.setFont(gridTitleFont); // 设置字体
					g2.drawString("违约金：", (float) leftPointX + 415, (float) (line + gridTitleFontHeight*1.5));
